"""
Django settings for voithos_django project.
...
ALLOWED_HOSTS = ['192.168.7.34', '127.0.0.1']
...
ROOT_URLCONF = 'voithos_django.urls'
...
WSGI_APPLICATION = 'voithos_django.wsgi.application'
